...
W3 = tf.get_variable('W3', [512, 512], initializer=tf.contrib.layers.xavier_initializer())
b3 = tf.Variable(tf.random_normal([512]), name='bias3')
L3 = tf.nn.relu(tf.matmul(L2, W3) + b3)

W4 = tf.get_variable('W4', [512, 512], initializer=tf.contrib.layers.xavier_initializer())
b4 = tf.Variable(tf.random_normal([512]), name='bias4')
L4 = tf.nn.relu(tf.matmul(L3, W4) + b4)

W5 = tf.get_variable('W5', [512, nb_classes], initializer=tf.contrib.layers.xavier_initializer())
